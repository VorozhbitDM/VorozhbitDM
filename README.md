...
| Проект | Описание |
| --- | --- |
| [**Access-control-1C**](https://github.com/VorozhbitDM/Access-control-1C) | Обработка для анализа и контроля прав доступа в 1С. |
| [**mcp-bsl-ls-029**](https://github.com/VorozhbitDM/mcp-bsl-ls-029) | MCP-сервер: статический анализ и форматирование BSL через BSL Language Server 0.29. |
